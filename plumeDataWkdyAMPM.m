...
numPlumes = find (~ismissing(dataSet.wkdyAM_Width500.PlumeCO));
Plumes1 = dataSet.wkdyAM_Width500 (numPlumes, :);
...
summary.meanTemp (1) = mean (dataSet.wkdyAM_Width500.Temp2, 'omitnan');
summary.medianTemp (1) = median (dataSet.wkdyAM_Width500.Temp2, 'omitnan');
...
summary.meanTemp (2) = mean (dataSet.wkdyAM_Width500.Temp2, 'omitnan');
summary.medianTemp (2) = median (dataSet.wkdyAM_Width500.Temp2, 'omitnan');
...
dataSet.plumesOnly.plumeswkdyAM_Width500 = output;
