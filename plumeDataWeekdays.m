...
numPlumes = find (~ismissing(dataSet.weekdays_Width500.PlumeCO));
Plumes1 = dataSet.weekdays_Width500 (numPlumes, :);
...
summary.meanTemp (1) = mean (dataSet.weekdays_Width500.Temp2, 'omitnan');
summary.medianTemp (1) = median (dataSet.weekdays_Width500.Temp2, 'omitnan');
...
summary.meanTemp (2) = mean (dataSet.weekdays_Width500.Temp2, 'omitnan');
summary.medianTemp (2) = median (dataSet.weekdays_Width500.Temp2, 'omitnan');
...
dataSet.plumesOnly.plumesWeekdays500 = output;

%% for width 750
% calculate number of plumes
numPlumes = find (~ismissing(dataSet.weekdays_Width750.PlumeCO));
Plumes1 = dataSet.weekdays_Width750 (numPlumes, :);
summary.numPlumes (1) = height(Plumes1);
...
summary.meanP (1) = mean (Plumes1.pCO,'omitnan');
summary.medianP (1) = median (Plumes1.pCO, 'omitnan');
summary.meanTemp (1) = mean (dataSet.weekdays_Width750.Temp2, 'omitnan');
summary.medianTemp (1) = median (dataSet.weekdays_Width750.Temp2, 'omitnan');
summary.meanTempPlumes (1) = mean (Plumes1.Temp2, 'omitnan');
summary.medianTempPlumes (1) = median (Plumes1.Temp2, 'omitnan');
...
summary.meanP (2) = mean (Plumes2.pCO,'omitnan');
summary.medianP (2) = median (Plumes2.pCO, 'omitnan');
summary.meanTemp (2) = mean (dataSet.weekdays_Width750.Temp2, 'omitnan');
summary.medianTemp (2) = median (dataSet.weekdays_Width750.Temp2, 'omitnan');
summary.meanTempPlumes (2) = mean (Plumes2.Temp2, 'omitnan');
summary.medianTempPlumes (2) = median (Plumes2.Temp2, 'omitnan');
...
dataSet.plumesOnly.plumesWeekdays750 = output750;
end
